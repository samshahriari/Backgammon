...
//        diceFaces.setBounds(610,500,60,30);
//        diceFaces.setBorder(BorderFactory.createLineBorder(new java.awt.Color(109, 50, 26), 3));
//        diceFaces.setBackground(new java.awt.Color(180, 100, 55));
//
//
//    }
//
...
//        int[] xp = new int[]{200,300,400};
//        int[] yp = new int[]{400,300,400};
